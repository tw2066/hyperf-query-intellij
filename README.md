...
* Table name completion, Ctrl+Click navigation and unknown-table inspection for the model `$table` property, scoped to the model's `$connection` (schema and table prefix are honored)
